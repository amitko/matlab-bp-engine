function res=DionYanevLogDensity(x,l,th_add,C)
% res=DionYanevLogDensity(x,l,th_add,Cell)
%   calculates the negative log of the density function for the robust estimator
